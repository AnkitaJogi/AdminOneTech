					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
					            ...
					            <thead>
					                <tr>
					                    ...
					                    <th  data-align="center" data-sortable="true">Sub Category</th>
                                    ...
                                    <tr data-index="0">
										...
										<td>sgag</td>
										<td>dfgd</td>
										<td><button class="btn btn-outline-success" style="background-color:#222;color:white;">Active</button>&nbsp;&nbsp;&nbsp;<button class="btn btn-outline-primary">Deactive</button></td>
									</tr>
