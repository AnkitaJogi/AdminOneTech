...
<%@page import="bean.Category" %>
 <%!
    ArrayList<Category> allcategory,subcategory;
    Category category;
	Iterator<Category> itr_cat,itr_sub;
%>
<% 
   ...
   if(session == null){
    ...
    subcategory=dao.getAllSubCategory();
    itr_cat = allcategory.iterator(); 
    itr_sub=subcategory.iterator();
%>    
<!DOCTYPE html>
<html>
<head>
  ...
  <![endif]-->
   ...
   <script type="text/javascript">
 	...
 	function deleteCategory()
	{
		...
		if(a.length>0){
		 		alert(a);
				document.location.href="category_delete.jsp?category_id="+a;
		}
		a=[];
	}	
	 var a = [];  
	...
	{
		v = confirm("Are You sure you want to Add Category Id");
		var flag = true;
		console.log(val);
		if(a.length == 0){
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="box-body">
               ...
               <h3 class="modal-title" id="myModalLabel">Add Sub Category</h3>
            </div>
			...
			<div class="form-group">
                  ...
                  <input type="text" name="subcategory" class="form-control" placeholder="Category Name">
                </div>
			  <!-- /.form group -->
            ...
            <!-- /.box-body -->
                  ...
                  <a class="tip"  onclick="deleteCategory();"  id="button"><img src="img/delete.png"  alt="Delete" style="margin-left:10px;"><span>Delete</span></a>  
					        ...
					        <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
					            ...
					            <thead>
					                <tr>
					                    ...
					                    <th  data-align="center" data-sortable="true">Sub Category Name</th>
					                </tr>
                                    
					            </thead>
					 
				<%while(itr_sub.hasNext()){
            	category = itr_sub.next();
                %>
                                    <tr data-index="0">
                                        <td><input type="checkbox" onclick="addCategory(<%=category.getCategory_id()%>);" /></td>
                                        <td><%=category.getSub_id() %></td>
                                        <td><%=category.getCategory() %></td>
                                        <td><%=category.getSubcategory() %>
									</tr>
				<%} %>				
