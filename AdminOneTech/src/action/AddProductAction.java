	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			while (iter.hasNext()) 
			{
				...
				else if (!item.isFormField() && item.getFieldName().equals("addimage1")) 
				{
				...
				if (!item.isFormField() && item.getFieldName().equals("addimage2")) 
				{
				...
				if (!item.isFormField() && item.getFieldName().equals("addimage3")) 
				{
				...
				if (!item.isFormField() && item.getFieldName().equals("addimage4")) 
				{
